...
const tools = [
  ...
  },
  {
    ...
    by: 'AEO by Nxt Apex',
    description:
      'ChatGPT, Perplexity, and Google AI Overviews recommend businesses to buyers every day. We audit how you appear in those answers, fix the gaps, and connect new AI-referred leads directly to your pipeline.',
    capabilities: [
      'AI citation audit & scoring',
      'Structured data & schema fixes',
      'Competitor citation analysis',
      'Pipeline-connected lead intake',
    ],
    bgFrom: '#F0F7FF',
    bgTo: '#F3F9FF',
